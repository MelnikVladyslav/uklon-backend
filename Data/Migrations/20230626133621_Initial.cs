...
namespace Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transports_Types_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.InsertData(
                table: "Transports",
                columns: new[] { "Id", "Description", "ImagePath", "Model", "OrderId", "Price", "TypeId" },
                values: new object[] { 1, "Test standart car", "https://cdn2.rcstatic.com/images/rc-guides/Economy_Cars/stan.jpg", "Test Car", null, 2000m, 3 });
